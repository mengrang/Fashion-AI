...
def train():
    ...
    model_save_dir = os.path.join('logs_and_weights_dilation_fpn',
                                  'models',
                                  'weights',
                                  model_path_suffix)
    train_log_save_dir = os.path.join('logs_and_weights_dilation_fpn',
                                      'models',
                                      'logs',
                                      model_path_suffix,
                                      'train')
    test_log_save_dir = os.path.join('logs_and_weights_dilation_fpn',
                                     'models',
                                     'logs',
                                     model_path_suffix,
                                     'test')
