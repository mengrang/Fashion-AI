...
def train():
    ...
    model_save_dir = os.path.join('logs_and_weights_hole',
                                  'models',
                                  'weights',
                                  model_path_suffix)
    train_log_save_dir = os.path.join('logs_and_weights_hole',
                                      'models',
                                      'logs',
                                      model_path_suffix,
                                      'train')
    test_log_save_dir = os.path.join('logs_and_weights_hole',
                                     'models',
                                     'logs',
                                     model_path_suffix,
                                     'test')
