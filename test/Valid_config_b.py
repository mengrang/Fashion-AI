class Valid_FLAGS(object):
    # run test use
    test_img_directory = '/home/wangzy/Documents/Youzhi Gu/data/test_b/'
    test_data_file = '/home/wangzy/Documents/Youzhi Gu/data/test_b/test.csv'
    processed_testimg_directory = './preprocess/processed_b'
    model_load_dir = './data_gu_stage_6'
    normalize_img = True
    if_show = False
    if_save = False
    total_num_joints = 24
